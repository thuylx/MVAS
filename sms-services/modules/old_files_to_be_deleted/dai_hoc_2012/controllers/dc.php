...
{    
    ...
    {        
        ...
        $this->MO->argument = preg_replace('/\snam\s/',' ',$this->MO->argument);
        $this->MO->argument = preg_replace('/\struong\s/',' ',$this->MO->argument);
    ...
    public function __initialize()
    {
        ...
        if (count($args) < 1)
        {
            write_log("debug", "Missing argument");
        ...
        $this->ma_truong = strtoupper($args[0]);
