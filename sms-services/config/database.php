...
$db['default']['pconnect'] = FALSE; //Donot use persistent connection for dev and testing environment
...
$db['mgw']['dbprefix'] = '';
$db['mgw']['pconnect'] = FALSE; //Donot use persistent connection for dev and testing environment
